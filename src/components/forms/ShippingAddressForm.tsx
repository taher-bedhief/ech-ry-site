...
const ShippingAddressForm = forwardRef(
  ({ onFormDataChange, initialData }: ShippingAddressFormProps, ref) => {
          ...
          <form className="space-y-4" onChange={onFormChange}>
            ...
            <FormField control={form.control} name="fullName" render={({ field }) => (
              <FormItem>
                ...
                <FormControl><Input {...field} aria-label="Shipping Name" /></FormControl>
                <FormMessage />
              </FormItem>
            )}/>
            ...
            <FormField control={form.control} name="phone" render={({ field }) => (
              <FormItem>
                ...
                <FormControl><Input {...field} aria-label="Shipping Phone" /></FormControl>
                <FormMessage />
              </FormItem>
            )}/>
            ...
            <div className="flex gap-4 flex-col md:flex-row">
              <FormField control={form.control} name="city" render={({ field }) => (
                <FormItem className="flex-1">
                  ...
                  <FormControl><Input {...field} aria-label="Shipping City" /></FormControl>
                  <FormMessage />
                </FormItem>
              )}/>
              <FormField control={form.control} name="state" render={({ field }) => (
                <FormItem className="flex-1">
                  ...
                  <FormControl><Input {...field} aria-label="Shipping State" /></FormControl>
                  <FormMessage />
                </FormItem>
              )}/>
            </div>
            ...
            <div className="flex gap-4 flex-col md:flex-row">
              <FormField control={form.control} name="postalCode" render={({ field }) => (
                <FormItem className="flex-1">
                  ...
                  <FormControl><Input {...field} aria-label="Shipping Postal Code" /></FormControl>
                  <FormMessage />
                </FormItem>
              )}/>
              <FormField control={form.control} name="streetAddress" render={({ field }) => (
                <FormItem className="flex-1">
                  ...
                  <FormControl><Input {...field} aria-label="Shipping Street Address" /></FormControl>
                  <FormMessage />
                </FormItem>
              )}/>
            </div>

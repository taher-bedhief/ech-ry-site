...
const ProfileSidebar = () => {
  ...
  const handleLogout = async () => {
    ...
    // Supprime l'utilisateur localement si nécessaire
    localStorage.removeItem("currentUser"); // ✅ optionnel, selon ton app

    setIsConfirm(false);
    router.push("/"); // redirige vers la home
  };
    ...
    <>
      ...
      >
        <div className="p-5 rounded-lg flex flex-col justify-center items-center text-center gap-3">
          <h2 className="text-lg">Are you sure you want to logout?</h2>

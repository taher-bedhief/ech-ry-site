...
const Footer = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        if (data.dev) {
          setMessage("🛠 DEV MODE: email non envoyé, log en console.");
        } else {
      ...
      <div className="container">
        <div className="flex flex-col items-center">
          ...
          <form
            ...
            className="flex justify-center items-center max-w-sm mx-auto w-full mt-3"
          >
            <Input
              type="email"
              name="email"
        ...
        {/* ✅ Le reste de ton footer inchangé */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mt-10 gap-14">
          <div>
            <Logo />
            <div className="dark:text-gray-400">
              <p className="mt-6">Ariana, Tunisia</p>

              <a href="mailto:tbedhief@gmail.com" className="block mt-3">
                tbedhief@gmail.com
              </a>
              <a href="tel:+21623606361" className="block mt-1">
                +216 23606361
              </a>
